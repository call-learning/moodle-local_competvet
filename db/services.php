...
$functions = [
    ...
    'local_competvet_edit_caselog' => [
        'classname' => \local_competvet\external\edit_caselog::class,
        'methodname' => 'execute',
        'description' => 'Edit caselog',
        'ajax' => true,
        'type' => 'write',
        'loginrequired' => true,
        'services' => [utils::COMPETVET_MOBILE_SERVICE],
    ],
    'local_competvet_delete_caselog' => [
        'classname' => \local_competvet\external\delete_caselog::class,
        'methodname' => 'execute',
        'description' => 'Delete caselog',
        'ajax' => true,
        'type' => 'write',
        'loginrequired' => true,
        'services' => [utils::COMPETVET_MOBILE_SERVICE],
