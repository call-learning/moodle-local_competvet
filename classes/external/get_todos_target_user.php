...
/**
 * Get current user's todo list (target user).
 *
 * @package   local_competvet
 * @copyright 2023 - CALL Learning - Laurent David <laurent@call-learning.fr>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_todos_target_user extends external_api {
    /**
    ...
    public static function execute(?int $userid = null): array {
        ...
        return todos::get_todos_for_target_user($userid);
    }
    ...
    public static function execute_parameters() {
        return new external_function_parameters(
            [
                'userid' => new external_value(PARAM_INT, 'id of the target user (optional parameter)', VALUE_DEFAULT, 0),
            ]
        );
    }
}
